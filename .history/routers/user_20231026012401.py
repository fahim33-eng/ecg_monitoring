...
from schemas import User, ResponseUser, ResponsePatient, Patient, UpdateUser, TestUser
...
def test_function(testUser : TestUser) :
    new_user = models.User(name=testUser.user.name, password=testUser.user.password, phone=testUser.user.phone)
    print(new_user)
    return "Hello"
